<?php
    ...
    if (isset($_GET['usuario_id'])) {
        ...
        $sql = "SELECT usuario_id, nome, login FROM seguranca_tbUsuarios WHERE usuario_id = $usuario_id";
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-body">
                    <h4 class="card-title text-center mb-4">Editar Usuário</h4>
                    <form id="formEditar">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="senha" name="senha" placeholder="Digite nova senha" required>
                        </div>
